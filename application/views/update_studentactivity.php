...
<script type="text/javascript">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-clipboard"></i><small> Manage Activity</small></h3>
   ...
   | <a href="<?php echo WEB_DIR?>student/activity/index"> Student Activity</a>                    
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_activity_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                    <li  class=""><a href="#tab_add_activity"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                                        
                                                    <li  class="active"><a href="#tab_edit_activity"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> Edit</a> </li>                          
                          
                            
                        <li class="li-class-list">
                             
                            
                                <form action="<?php echo WEB_DIR?>student/activity/index" name="filter" id="filter" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_activity_list" >
                            <div class="x_content">
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    ...
                                    {
                                        ?>
                                           <tr id="activity_<?php echo $row->id;?>">
                                            ...
                                            <td>
                                            <a href="<?php echo WEB_URL?>Student/UpdateStudentActivity/<?php echo $row->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                            <a  onclick="get_activity_modal(1);"  data-toggle="modal" data-target=".bs-activity-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View </a>
                                            <a href="#" onclick="return DeleteStudentActivity('<?php echo $row->id;?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                                                                            </td>
                                        </tr>
                                        <?php
                                    }
                        ...
                        <div  class="tab-pane fade in " id="tab_add_activity">
                            <div class="x_content"> 
                            <form action="<?php echo WEB_URL?>Student/InsertStudentActivity" name="add" id="add" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
         ...
         <?php
                 ...
                 <div class="help-block"></div>
                                         ...
                                         <div class="item form-group">
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="student_id">Student <span class="required">*</span>
                                             </label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group"> 
                                             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="activity_date">Date<span class="required"> *</span></label>
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                 <input  class="form-control col-md-7 col-xs-12"  name="activity_date"  id="add_activity_date" value="" placeholder="Date" required="required" type="text" autocomplete="off">
                                                 <div class="help-block"></div>
                                             </div>
                                         </div>
                                         ...
                                         <div class="item form-group">
                                             ...
                                             <div class="col-md-6 col-sm-6 col-xs-12">
                                                 <textarea  class="form-control col-md-7 col-xs-12"  name="activity"  id="activity" placeholder="Activity"></textarea>
                                                 <div class="help-block"></div>
                                             </div>
                                         </div>
                                         ...
                                         <div class="form-group">
                                             <div class="col-md-6 col-md-offset-3">
                                                 <a href="<?php echo WEB_URL?>Student/InsertStudentActivity" class="btn btn-primary">Cancel</a>
                            ...
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Student/UpdateStudentActivity/<?php echo $activity_data->id;?>" name="edit" id="edit" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="1" />
                                ...
                                <div class="form-group"> 
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="activity_date">Date<span class="required"> *</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="activity_date"  id="edit_activity_date" value="<?php echo $activity_data->activity_date?>" placeholder="Date" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="activity">Activity</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="activity"  id="activity" placeholder="Activity"><?php echo $activity_data->activity?></textarea>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
  ...
  $('#edit_activity_date').datepicker(); 
    ...
    function get_section_by_class(class_id, section_id, type){       
        ...
        $.ajax({       
            ...
            get_student_by_section('1', '4','edit');
    ...
    function get_student_by_section(section_id, student_id, type){       
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo WEB_DIR?>ajax/get_student_by_section",
...
function DeleteStudentActivity(id){
    ...
    if(confText){
      $.ajax({
         url:"<?php echo WEB_URL?>Student/ajaxActivityDelete",
         data:{id:id},
         type:"POST",

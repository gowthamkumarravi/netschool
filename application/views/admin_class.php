...
<html lang="en">
    <head>
        ...
        <title>Add | Dot Net Schools</title>
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_class_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                     <li  class="active"><a href="#tab_add_class"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                        ...
                        <li class="li-class-list">
                            ...
                            <select  class="form-control col-md-7 col-xs-12" onchange="get_class_by_school(this.value);">
                                    <option value="<?php echo WEB_DIR?>academic/classes/index">--Select School--</option> 
                                                                    <option value="<?php echo WEB_DIR?>academic/classes/index/1"  > qw</option>
...
?>
                                            ...
                                            <td><a href="<?php echo WEB_URL?>Academic/UpdateClass/<?php echo $row->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                            <a href="#" onclick="return DeleteClass('<?php echo $row->id;?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>                                                                                            </td>
                                        </tr>
                                         <?php
                        ...
                        <div  class="tab-pane fade in active" id="tab_add_class">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Academic/AdminClass" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">

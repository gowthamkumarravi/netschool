...
<html lang="en">
    <head>
        ...
        <title>Manage Section | Dot Net Schools</title>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="active"><a href="#tab_section_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                    <li  class=""><a href="#tab_add_section"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                        ...
                        <li class="li-class-list">
                                 ...
                                 <form action="<?php echo WEB_URL?>Academic/SectionInsert" name="filter" id="filter" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_section_list" >
                            <div class="x_content">
                        ...
                        <div  class="tab-pane fade in " id="tab_add_section">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Academic/SectionInsert" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="help-block"></div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 select2"  name="class_id"  id="add_class_id" >

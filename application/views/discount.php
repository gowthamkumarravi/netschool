...
<html lang="en">
    <head>
        ...
        <title>Manage Discount | Dot Net Schools</title>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="active"><a href="#tab_discount_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                        ...
                        <li class="li-class-list">
                             ...
                             <select  class="form-control col-md-7 col-xs-12" onchange="get_discount_by_school(this.value);">
                                     <option value="<?php echo WEB_DIR?>accounting/discount/index">--Select School--</option> 
                                                                      <option value="<?php echo WEB_DIR?>accounting/discount/index/1"  > vds jain</option>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_discount_list" >
                            <div class="x_content">
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <?php
                                       ...
                                       {
                                        ?>                                                                              <tr id="discount_<?php echo $row->id;?>">
                                            ...
                                            <a href="#" onclick="return DeleteDiscount('<?php echo $row->id;?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
...
function DeleteDiscount(id){
    ...
    if(confText){
      $.ajax({
         url:"<?php echo WEB_URL?>Manage_School/ajaxDiscountDelete",
         data:{id:id},
         type:"POST",

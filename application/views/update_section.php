...
<script type="text/javascript">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bars"></i><small> Manage Section</small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_section_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                    <li  class=""><a href="<?php echo WEB_URL?>Academic/SectionInsert"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                                                       
                                                    <li  class="active"><a href="#tab_edit_section"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> Edit</a> </li>                          
                        ...
                        <li class="li-class-list">
                                 ...
                                 <form action="<?php echo WEB_DIR?>academic/section/index" name="filter" id="filter" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_section_list" >
                            <div class="x_content">
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>  
                                     ...
                                     {
                                        ?>
                                            <tr id="section_<?php echo $row->id;?>">
                                            ...
                                            <td>
                                            <a href="<?php echo WEB_URL?>Academic/SectionUpdate/<?php echo $row->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                            <a href="#" onclick="return DeleteSection('<?php echo $row->id;?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                                                                            </td>
                                        </tr>
                                        <?php
                                        }
                        ...
                        <div  class="tab-pane fade in " id="tab_add_section">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_DIR?>academic/section/add" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
        ...
        <div class="help-block"></div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo WEB_DIR?>academic/section/index" class="btn btn-primary">Cancel</a>
                                        <button id="send" type="submit" class="btn btn-success">Submit</button>
                                    </div>
                                </div>
                                </form>                                
                                 <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="instructions"><strong>Instruction: </strong> Please add Teacher & Class before add Section.</div>
                                </div>
                            ...
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Academic/SectionUpdate/<?php echo $section_data->id?>" name="edit" id="edit" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="1" />
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo $section_data->name?>" placeholder="Section Name" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note">Note</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="note"  id="note" placeholder="Note"><?php echo $section_data->note?></textarea>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <a href="<?php echo WEB_URL?>Academic/SectionInsert" class="btn btn-primary">Cancel</a>
...
function DeleteSection(id){
    ...
    if(confText){
      $.ajax({
         url:"<?php echo WEB_URL?>Academic/ajaxAcademicDelete",
         data:{id:id},
         type:"POST",

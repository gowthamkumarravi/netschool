...
| <a href="<?php echo WEB_DIR?>teacher/lecture/index">Class Lecture</a>
  ...
  |  <a href="<?php echo WEB_DIR?>teacher/rating/manage">Rating</a>                         
                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_teacher_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                            ...
                                                            <li  class=""><a href="#tab_add_teacher"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
    ...
    ?>
                        ...
                        <div  class="tab-pane fade in active" id="tab_add_teacher">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Manage_School/AddTeacher" name="add" id="add" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">

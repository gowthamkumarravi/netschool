...
<html lang="en">
    <head>
        ...
        <title>Manage Academic Year | Dot Net Schools</title>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="active"><a href="#tab_year_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                        
                                                                                            <li  class=""><a href="#tab_add_year"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                            ...
                            <li class="li-class-list">
                                    ...
                                    <select  class="form-control col-md-7 col-xs-12" onchange="get_year_by_school(this.value);">
                                        <option value="<?php echo WEB_DIR?>administrator/year/index">--Select School--</option> 
                                                                                    <option value="<?php echo WEB_DIR?>administrator/year/index/1"  > qw</option>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_year_list" >
                            <div class="x_content">
...
?>
                        ...
                        <div  class="tab-pane fade in " id="tab_add_year">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Manage_School/InsertAcademicYear" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
...
<?php
        ...
        <div class="help-block"></div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text"  class="form-control col-md-7 col-xs-12"  name="session_start"  id="add_session_start" value=""  placeholder="Session Start" required="required" autocomplete="off"/>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="text"  class="form-control col-md-7 col-xs-12"  name="session_end"  id="add_session_end" value=""  placeholder="Session End" required="required" autocomplete="off"/>
                                        <div class="help-block"></div>
                                    </div>
                                </div>

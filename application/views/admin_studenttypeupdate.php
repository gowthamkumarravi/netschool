   ...
   | <a href="<?php echo WEB_DIR?>student/activity/index"> Student Activity</a>                    
                ...
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_type_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                     <li  class=""><a href="<?php echo WEB_URL?>Student/AdminStudentType"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                        ...
                        <li class="li-class-list">
                                ...
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_type_by_school(this.value);">
                                        <option value="<?php echo WEB_DIR?>student/type/index">--Select School--</option> 
                                                                            <option value="<?php echo WEB_DIR?>student/type/index/1" selected="selected" > qw</option>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_type_list" >
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <?php
                                       ...
                                       {
                                        ?>    
                                            <tr id="school_<?php echo $row->type_id;?>">
                        ...
                        <div  class="tab-pane fade in " id="tab_add_type">
                            <div class="x_content"> 
                               <form action="" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="help-block"></div>
                            ...
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Student/UpdateAdminStudentType/<?php echo $StudentData->id;?>" name="edit" id="edit" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="1" />
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type">Student Type <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">                                        
                                        <input  class="form-control col-md-7 col-xs-12"  name="type" value="<?php echo $StudentData->type;?>"  placeholder="Student Type" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>    
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note">Note</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="note"  id="note" placeholder="Note"><?php echo $StudentData->note?></textarea>
                                        <div class="help-block"></div>
                                    </div>
                                </div>

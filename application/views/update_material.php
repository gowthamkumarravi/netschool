...
<script type="text/javascript">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-file-text-o"></i><small> Manage Study Material</small></h3>
...
| <a href="<?php echo WEB_DIR?>academic/submission/index">Submission</a>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_material_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                    <li  class=""><a href="<?php echo WEB_URL?>Academic/MaterialInsert"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                                                                     
                                                    <li  class="active"><a href="#tab_edit_material"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> Edit</a> </li>                          
                            ...
                            <li class="li-class-list">
                                    ...
                                    <form action="<?php echo WEB_DIR?>academic/material/index" name="filter" id="filter" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_material_list" >
                            <div class="x_content">
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <?php
                                    ...
                                    {
                                        ?>
                                            <tr id="material_<?php echo $row->id;?>">
                                            ...
                                            <td>
                                            <a href="<?php echo WEB_URL?>Academic/MaterialUpdate/<?php echo $row->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                            <a  onclick="get_material_modal(1);"  data-toggle="modal" data-target=".bs-material-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View </a>
                                            <a href="#" onclick="return DeleteMaterial('<?php echo $row->id;?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                                                                            </td>
                                        </tr>
                                    <?php
                                    }
                        ...
                        <div  class="tab-pane fade in " id="tab_add_material">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_DIR?>academic/material/add" name="add" id="add" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="help-block"></div>
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> Upload                                            <input  class="form-control col-md-7 col-xs-12"  name="material"  id="material" type="file">
                                        </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="description"  id="add_description" placeholder="Description"></textarea>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo WEB_DIR?>academic/material/index" class="btn btn-primary">Cancel</a>
                            ...
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Academic/MaterialUpdate/<?php echo $material_data->id?>" name="edit" id="edit" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="1" />
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo $material_data->title?>" placeholder="Title" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Material</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="hidden" name="prev_material" id="prev_material" value="" />
                                                                                <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> Upload                                            <input  class="form-control col-md-7 col-xs-12"  name="material"  id="edit_material" type="file">
                                        </div>
                                        <div class="text-info">Document file format: .pdf, .doc/docx, .ppt/pptx  or .txt</div>
                                        <div class="help-block"></div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">Description</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="description"  id="edit_description" placeholder="Description"><?php echo $material_data->description?></textarea>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function get_material_modal(material_id){
        ...
        $('.fn_material_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo WEB_DIR?>assets/images/loading.gif" /></p>');
        $.ajax({       
          type   : "POST",
          url    : "<?php echo WEB_DIR?>academic/material/get_single_material",
...
function DeleteMaterial(id){
    ...
    if(confText){
      $.ajax({
         url:"<?php echo WEB_URL?>Academic/ajaxmaterialDelete",
         data:{id:id},
         type:"POST",

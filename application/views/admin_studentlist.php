...
<html lang="en">
    <head>
        ...
        <title>Manage Student | Dot Net Schools</title>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                            ...
                            <li class="active"><a href="#tab_student_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                                 <li  class=""><a href="#tab_add_student"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                    ...
                    <div class="tab-content">
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <?php
                                       foreach($emrolldata as $row)
                                       {
                                        ...
                                        <a href="javascript:void(0);" onclick="get_student_modal(7);"  data-toggle="modal" data-target=".bs-student-modal-lg" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View </a><br/>
                        ...
                        <div  class="tab-pane fade in " id="tab_add_student">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL ?>Student/InsertStudent" name="add" id="add" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="class_id" id="add_class_id"onchange="get_section_by_class(this.value, '');">
                                            <?php
                                    ...
                                    <div class="row">     
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input  class="form-control col-md-7 col-xs-12"  name="gud_username"  id="add_gud_username" value="Gud29713" placeholder="Username"  type="text" required="required">
                                                <div class="help-block"></div>
                                            </div>
                                        </div>                                        
...
function DeleteStudent(id){
 ...
 <script type="text/javascript">
    ...
    function get_class_by_school(school_id, class_id){
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo WEB_URL?>Student/get_class_by_school",
            data   : { school_id : school_id, class_id : class_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
    ...
    function update_status_type(student_id, status){
        ...
        $.ajax({       
            type   : "POST",
            url    : "<?php echo WEB_URL?>ajax/update_student_status_type",

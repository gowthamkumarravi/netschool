...
<html lang="en">
    <head>
        ...
        <title>Manage Study Material | Dot Net Schools</title>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="active"><a href="#tab_material_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                    <li  class=""><a href="#tab_add_material"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_material_list" >
                            <div class="x_content">
                        ...
                        <div  class="tab-pane fade in " id="tab_add_material">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Academic/MaterialInsert" name="add" id="add" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">

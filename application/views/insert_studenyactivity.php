...
<html lang="en">
    <head>
        ...
        <title>Manage Activity | Dot Net Schools</title>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="active"><a href="#tab_activity_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_activity_list" >
                            <div class="x_content">

...
<script type="text/javascript">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-calculator"></i><small> Manage Discount</small></h3>
     ...
     <a href="<?php echo WEB_DIR?>accounting/discount/index">Discount</a>                  
  

   | <a href="<?php echo WEB_DIR?>accounting/feetype/index">Fee Type</a>                  
  

 
             | <a href="<?php echo WEB_DIR?>accounting/invoice/add">Fee Collection</a>
         | <a href="<?php echo WEB_DIR?>accounting/invoice/index">Manage Invoice</a>
         | <a href="<?php echo WEB_DIR?>accounting/invoice/due">Due Invoice</a>    
      
  

   
       | <a href="<?php echo WEB_DIR?>accounting/receipt/duereceipt">Due Receipt</a>
       | <a href="<?php echo WEB_DIR?>accounting/receipt/paidreceipt">Paid Receipt</a>
   
     | <a href="<?php echo WEB_DIR?>accounting/duefeeemail/index">Due Fee Email</a>                  
       | <a href="<?php echo WEB_DIR?>accounting/duefeesms/index">Due Fee SMS</a>                  
          

     | <a href="<?php echo WEB_DIR?>accounting/incomehead/index">Income Head</a>                  
  
      | <a href="<?php echo WEB_DIR?>accounting/income/index">Income</a>                     
   
     | <a href="<?php echo WEB_DIR?>accounting/exphead/index">Expenditure Head</a>                  
  
     | <a href="<?php echo WEB_DIR?>accounting/expenditure/index">Expenditure</a>                  
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_discount_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                    <li  class=""><a href="#tab_add_discount"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                                                                            <li  class="active"><a href="#tab_edit_discount"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> Edit</a> </li>                          
                                                    
                        <li class="li-class-list">
                                                         
                             <select  class="form-control col-md-7 col-xs-12" onchange="get_discount_by_school(this.value);">
                                     <option value="<?php echo WEB_DIR?>accounting/discount/index">--Select School--</option> 
                                                                      <option value="<?php echo WEB_DIR?>accounting/discount/index/1" selected="selected" > vds jain</option>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_discount_list" >
                            <div class="x_content">
                                ...
                                <?php
                                       foreach($discount as $row)
                                       {
                                        ?><tr>
                                            ...
                                            <td>                                               
                                            <a href="<?php echo WEB_URL?>Manage_School/UpdateDiscount/<?php echo $row->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                            <a href="<?php echo WEB_DIR?>accounting/discount/delete/1" onclick="javascript: return confirm('Are you sure you want to delete this');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                        ...
                        <div  class="tab-pane fade in " id="tab_add_discount">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Manage_School/FeesDiscount" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
...
<?php
        ...
        <div class="help-block"></div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="discount_type">Discount Type <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="amount"  id="amount" value="" placeholder="Amount" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>                                
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo WEB_DIR?>accounting/discount/index" class="btn btn-primary">Cancel</a>
                            ...
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Manage_School/UpdateDiscount/<?php echo $discountdata->id;?>" name="edit" id="edit" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="1" />
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo $discountdata->title;?>" placeholder="Title" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12" name="discount_type" id="discount_type" required="required">
                                            <option value="">--Select--</option>                                                                                    
                                            <option value="flat" >Flat Amount</option>                                           
                                            <option value="percentage" selected="selected">Percentage Amount</option>                                           
                                        </select>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="amount"  id="amount" value="<?php echo $discountdata->amount;?>" placeholder="Amount" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note">Note</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="note"  id="note" placeholder="Note"><?php echo $discountdata->note;?></textarea>
                                        <div class="help-block"></div>
                                    </div>
                                </div>

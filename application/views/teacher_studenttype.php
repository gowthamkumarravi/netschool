...
<html lang="en">
    <head>
        ...
        <title>Manage Student Type | qw</title>
                ...
                <div class="" data-example-id="togglable-tabs">                    
                    ...
                    <div class="tab-content">
                        ...
                        <div  class="tab-pane fade in " id="tab_add_type">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Student/TeacherStudentType" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">

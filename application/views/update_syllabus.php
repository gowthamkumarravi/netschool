...
| <a href="<?php echo WEB_DIR?>academic/submission/index">Submission</a>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_syllabus_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                    <li  class=""><a href="<?php echo WEB_URL?>Academic/SyllabusInsert"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                                                                     
                                                    <li  class="active"><a href="#tab_edit_syllabus"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> Edit</a> </li>                          
                            ...
                            <li class="li-class-list">
                                    ...
                                    <form action="<?php echo WEB_DIR?>academic/syllabus/index" name="filter" id="filter" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_syllabus_list" >
                            <div class="x_content">
                        ...
                        <div  class="tab-pane fade in " id="tab_add_syllabus">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_DIR?>academic/syllabus/add" name="add" id="add" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="help-block"></div>
                               ...
                               <div class="item form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo WEB_URL?>Academic/SyllabusUpdate" class="btn btn-primary">Cancel</a>
                            ...
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Academic/SyllabusUpdate/<?php echo $syllabus_data->id?>" name="edit" id="edit" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="1" />
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo $syllabus_data->title?>" placeholder="Title" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Syllabus  </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input type="hidden" name="prev_syllabus" id="prev_syllabus" value="" />
                                                                                <div class="btn btn-default btn-file">
                                            <i class="fa fa-paperclip"></i> Upload                                            <input  class="form-control col-md-7 col-xs-12"  name="syllabus"  id="syllabus" type="file">
                                        </div>
                                        <div class="text-info">Document file format: .pdf, .doc/docx, .ppt/pptx  or .txt</div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note">Note</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="note"  id="edit_note" placeholder="Note"><?php echo $syllabus_data->note?></textarea>
                                        <div class="help-block"></div>
                                    </div>
                                </div>

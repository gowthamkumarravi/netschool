...
| <a href="<?php echo WEB_DIR?>academic/submission/index">Submission</a>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_liveclass_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                
                                                            <li  class=""><a href="<?php echo WEB_DIR?>academic/liveclass/add"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                                                      
                                                    <li  class="active"><a href="#tab_edit_liveclass"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> Edit</a> </li>                          
                            ...
                            <li class="li-class-list">
                                    ...
                                    <select  class="form-control col-md-7 col-xs-12" onchange="get_live_class_list_by_class(this.value);">
                                        <option value="<?php echo WEB_DIR?>academic/liveclass/index">--Select--</option> 
                                                                                                                                                                                    <option value="<?php echo WEB_DIR?>academic/liveclass/index/1" selected="selected" >1st standard</option>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_liveclass_list" >                            
                            <div class="x_content">
                        ...
                        <div  class="tab-pane fade in " id="tab_add_liveclass">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_DIR?>academic/liveclass/add" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input class="fn_school_id" type="hidden" name="school_id" id="add_school_id" value="1" />
                            ...
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Academic/LiveClassUpdate/<?php echo $liveclass_data->id?>" name="edit" id="edit" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
...
?>                                                                                        
                                    ...
                                    <div class="item form-group">                                       
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="hidden" name="teacher_id" id="edit_teacher_id" value="1" />
                                        </div>
                                    </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12 data_subject"  name="class_type" id="add_class_type" required="required" onchange="set_live_class_type(this.value, 'edit');">
                                            <option value="">--Select--</option>                                                                                         
                                                                                            <option value="zoom" selected="selected">Zoom Meet</option>
                                                                                            <option value="jitsi" >Jitsi Meet</option>
                                                                                            <option value="google" >Google Meet</option>
                                                                                    </select>
                                        <div class="help-block"></div>
                                ...
                                <div class="fn_edit_zoom_setting ">
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="meeting_id">Meeting ID <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="meeting_id"  id="edit_meeting_id" value="" placeholder="Meeting ID" required="required" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="meeting_password">Meeting Password <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="meeting_password"  id="edit_meeting_password" value="" placeholder="Meeting Password" required="required" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="fn_edit_google_setting display">
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="meeting_url">Meeting URL <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input  class="form-control col-md-7 col-xs-12"  name="meeting_url"  id="edit_meeting_url" value="" placeholder="Meeting URL" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="class_date">Class Date <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="class_date"  id="edit_class_date" value="28-06-2023" placeholder="Class Date" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="start_time">Start Time <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="start_time"  id="edit_start_time" value="10:30 AM" placeholder="Start Time" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="end_time">End Time <span class="required">*</span> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="end_time"  id="edit_end_time" value="10:30 AM" placeholder="End Time" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note">Note</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="note"  id="note" placeholder="Note">sdsd</textarea>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
    ...
    function get_live_class_list_by_class(url){          
       if(url){
           window.location.href = url; 
            ...
            get_class_by_school_filter('1', '1');

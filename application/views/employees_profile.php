...
<html lang="en">
    <head>
        ...
        <title>My Profile | vds jain</title>
                            ...
                            <div class="x_content">  
                                ...
                                <div class="col-md-12">
                                    <div class="profile_img">
                                                                                 <img style="height:75px;width:100px;"src="<?php echo WEB_IMG?>image/<?php echo $employees->photo?>"> 
                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <tbody>
                                        <tr>
                                            ...
                                            <th>National ID</th>
                                            <td><?php echo $employees->national_id?></td>
                                        </tr>
                                        <tr>
                                            <th>Designation</th>
                                            <td>Staff</td>        
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $employees->permanent_address?></td>
                                        </tr>
                                        <tr>
                                            <th>Gender</th>
                                        ...
                                        <tr>
                                            ...
                                            <th>Other Info</th>
                                            <td><?php echo $employees->other_info?></td>
                                        </tr>
                            ...
                            <form action="<?php echo WEB_URL?>Profile/index" name="profile" id="profile" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo $employees->name?>" placeholder="Name" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="national_id"  id="national_id" value="<?php echo $employees->national_id?>" placeholder="National ID" type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="designation_id"  id="designation_id" value="" placeholder="Designation" type="text" readonly="readonly" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>                                  
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo $employees->phone?>" placeholder="Phone" required="required" minlength="6" maxlength="20" type="number" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>                                    
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="gender">Gender <span class="required">*</span></label>
                                             <select  class="form-control col-md-7 col-xs-12"  name="gender"  id="gender" value="" required="required">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12" name="blood_group" id="blood_group">
                                                <option value="">--Select--</option> 
                                                <option value="A_positive" <?php echo $employees->blood_group =="A_positive"?"selected":"" ?>>A+</option>
                                                <option value="A_negative" <?php echo $employees->blood_group =="A_negative"?"selected":""?> >A-</option>
                                                <option value="B_positive" <?php echo $employees->blood_group =="B_positive"?"selected":""?> >B+</option>
                                                <option value="B_negative" <?php echo $employees->blood_group =="B_negative"?"selected":""?> >B-</option>
                                                <option value="O_positive" <?php echo $employees->blood_group =="O_positive"?"selected":""?> >O+</option>
                                                <option value="O_negative" <?php echo $employees->blood_group =="O_negative"?"selected":""?> >O-</option>
                                                <option value="AB_positive" <?php echo $employees->blood_group =="AB_positive"?"selected":""?>>AB+</option>
                                                <option value="AB_negative" <?php echo $employees->blood_group =="AB_negative"?"selected":""?>>AB-</option>
                                            </select>
                                        <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="religion"  id="religion" value="<?php echo $employees->religion?>" placeholder="Religion" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="dob"  id="edit_dob" value="<?php echo $employees->dob?>"placeholder="Birth Date"  type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <textarea  class="form-control col-md-7 col-xs-12 textarea-4column" value=""name="present_address"  id="present_address" placeholder="Present Address" rows="10" cols="70"><?php echo $employees->present_address?></textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <textarea  class="form-control col-md-7 col-xs-12 textarea-4column" value="" name="permanent_address"  id="permanent_address"  placeholder="Permanent Address"  rows="10" cols="70"><?php echo $employees->permanent_address?></textarea>
                                        <div class="help-block"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row"> 
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="email"  id="email" value="<?php echo $employees->email?>" placeholder="Email" type="email" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>                                    
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="username"  id="" readonly="readonly" value="demo" placeholder="Username"  type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>                           
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="joining_date"  id="edit_joining_date" value="" placeholder="Joining Date" readonly="readonly" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="other_info" value=""  id="other_info" placeholder="Other Info" row="10" cols="70"><?php echo $employees->other_info?> </textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo WEB_URL?>Profile/profilepage" class="btn btn-primary">Cancel</a>

...
<script type="text/javascript">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-paw"></i><small> Manage Guardian</small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_guardian_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                    <li  class=""><a href="<?php echo WEB_URL?>Guardian/index"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                                                                                                         <li  class="active"><a href="#tab_edit_guardian"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> Edit</a> </li>                          
                                                    
                                                    
                        <li class="li-class-list">
                                                            
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_guardian_by_school(this.value);">
                                        <option value="<?php echo WEB_DIR?>guardian/index">--Select School--</option> 
                                                                            <option value="<?php echo WEB_DIR?>guardian/index/1" selected="selected" > vds jain</option>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_guardian_list" >
                            <div class="x_content">
                                ...
                                <tbody>   
                                    ...
                                    foreach($guardian as $row)
                                    {
                                        ?>
                                            ...
                                            <tr id="guardian_<?php echo $row->id;?>">
                                            ...
                                            <td>
                                            <a href="<?php echo WEB_URL?>Guardian/UpdateGuardian/<?php echo $row->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Edit</a>
                                            <a  onclick="get_guardian_modal(11);"  data-toggle="modal" data-target=".bs-guardian-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View </a><br/>
                                            <a href="#" onclick="return DeleteGuardian('<?php echo $row->id;?>')" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                                                                            </td>
                                        </tr>
...
?>                                         
                        ...
                        <div  class="tab-pane fade in " id="tab_add_guardian">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_DIR?>guardian/add" name="add" id="add" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        ...
        <div class="help-block"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="profession"  id="profession" value="" placeholder="Profession" required="required" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <a href="<?php echo WEB_URL?>Guardian/index" class="btn btn-primary">Cancel</a>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_guardian">
                            <div class="x_content"> 
                            <form action="<?php echo WEB_URL?>Guardian/UpdateGuardian/<?php echo $GuardianData->id;?>" name="edit" id="edit" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        ...
        <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="1" />
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="name">Name <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo $GuardianData->name?>" placeholder="Name" required="required" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="phone">Phone <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo $GuardianData->phone?>" placeholder="Phone" required="required" minlength="6" maxlength="20" type="number" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="profession">Profession <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="profession"  id="profession" value="<?php echo $GuardianData->profession?>" placeholder="Profession" required="required" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="religion">Religion </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="religion"  id="religion" value="<?php echo $GuardianData->religion?>" placeholder="Religion" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            <label for="present_address">Present Address</label>
                                            <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="present_address"  id="present_address" placeholder="Present Address"><?php echo $GuardianData->present_address?></textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            <label for="permanent_address">Permanent Address</label>
                                            <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="permanent_address"  id="permanent_address" placeholder="Permanent Address"><?php echo $GuardianData->permanent_address?></textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="national_id">National ID</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="national_id"  id="national_id" value="<?php echo $GuardianData->national_id?>" placeholder="National ID"  type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="email">Email</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="email"   id="email" value="<?php echo $GuardianData->email?>" placeholder="Email" type="email" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="username"  id="username" readonly="readonly" value="Gud23669" placeholder="Username" type="text" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            <label for="other_info">Other Info </label>
                                            <textarea  class="form-control col-md-7 col-xs-12 textarea-4column"  name="other_info"  id="other_info" placeholder="Other Info"><?php echo $GuardianData->other_info?></textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
...
<script type="text/javascript">
    ...
    function get_guardian_modal(guardian_id){
        ...
        $('.fn_guardian_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo WEB_DIR?>assets/images/loading.gif" /></p>');
        $.ajax({       
          type   : "POST",
          url    : "<?php echo WEB_DIR?>guardian/get_single_guardian",
...
function DeleteGuardian(id){
    ...
    if(confText){
      $.ajax({
         url:"<?php echo WEB_URL?>Guardian/ajaxguardianDelete",
         data:{id:id},
         type:"POST",

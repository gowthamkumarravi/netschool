...
<html lang="en">
    <head>
        ...
        <title>Manage Guardian | Dot Net Schools</title>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        <li class="active"><a href="#tab_guardian_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                    <li  class=""><a href="#tab_add_guardian"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                        ...
                        <li class="li-class-list">
                                ...
                                <select  class="form-control col-md-7 col-xs-12" onchange="get_guardian_by_school(this.value);">
                                        <option value="<?php echo WEB_DIR?>guardian/index">--Select School--</option> 
                                                                            <option value="<?php echo WEB_DIR?>guardian/index/1"  > vds jain</option>
                    ...
                    <div class="tab-content">
                                ...
                                <?php
                                       foreach($guardian as $row)
                                       {
                                        ?>                                                                   
                                            ...
                                            <a  onclick="get_guardian_modal(8);"  data-toggle="modal" data-target=".bs-guardian-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View </a><br/>
                        ...
                        <div  class="tab-pane fade in " id="tab_add_guardian">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Guardian/index" name="add" id="add" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">

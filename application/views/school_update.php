            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                                                <li class=""><a href="#tab_school_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                              
                        
                                                            <li  class=""><a href="<?php echo WEB_URL?>Manage_School/index"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                                                                            
                            
                                                    <li  class="active"><a href="#tab_edit_school"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> Edit</a> </li>                          
                         
                    </ul>
                    <br/>
                    
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_school_list" >
                            <div class="x_content">
                            ...
                            foreach($schools as $row)
                            {
                                ?>
                                            ...
                                            <?php echo $row->school_name?><br/>
                                                                                                    <a class="btn btn-success btn-xs" target="_blank" href="<?php echo WEB_DIR?>https://www.youtube.com/">Visit School</a>
                                                                                            </td>
                                            <td>
                                                <select  class="form-control col-md-7 col-xs-12 status-type"  name="subscription_id"  id="subscription_id" onchange="update_subscription_status('15', this.value);" style="float: left;">
                                                    <option value="">--Select--</option>
                                                                                                            <option value="1" >Demo School [Higher Secondary<br/>/Active Student per Annum]</option>
                                                                                                            <option value="3" >Vanavil [Primary <br/>/Active Student per Annum]</option>
                                                                                                            <option value="4" >Vanavil [Primary <br/>/Active Student per Annum]</option>
                                                                                                            <option value="5" >Vanavil [Primary <br/>/Active Student per Annum]</option>
                                                                                                            <option value="6" >Vanavil [Primary <br/>/Active Student per Annum]</option>
                                                                                                            <option value="7" >Vanavil [Primary <br/>/Active Student per Annum]</option>
                                                                                                            <option value="8" >Vanavil [Primary <br/>/Active Student per Annum]</option>
                                                                                                            <option value="9" >Vanavil [Primary <br/>/Active Student per Annum]</option>
                                                                                                            <option value="10" >Vanavil [Primary <br/>/Active Student per Annum]</option>
                                                                                                            <option value="11" >Vanavil [Primary <br/>/Active Student per Annum]</option>
                                                                                                    </select><br/>
                                                
                                                                                                <a class="btn btn-danger btn-xs" href="javascript:void(0);"></a>
                                                <a class="btn btn-danger btn-xs" href="<?php echo WEB_DIR?>subscription/edit/11">Update Status</a>
                                                    
                                            </td>
                                            <td>
                                                <input class="fn_is_demo" onclick="set_demo_school(15);" type="checkbox" name="is_demo" id="is_demo_15" value="15"  />
                                            </td>
                                            ...
                                            <td>Active</td>
                                            <td>
                                                                                                    <a  onclick="get_school_modal(15);"  data-toggle="modal" data-target=".bs-school-modal-lg"  class="btn btn-success btn-xs"><i class="fa fa-eye"></i> View </a><br/>
                                                                                                 ...
                                                                                                 <a href="<?php echo WEB_DIR?>administrator/school/delete/15" onclick="javascript: return confirm('Are you sure you want to delete this');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                                                                                            </td>
                                        </tr>
                        ...
                        <div  class="tab-pane fade in " id="tab_add_school">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>administrator/school/add" name="add" id="add" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> Upload                                                <input  class="form-control col-md-7 col-xs-12"  name="frontend_logo" id="frontend_logo"  type="file">
                                            </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="btn btn-default btn-file"><i class="fa fa-paperclip"></i> Upload                                                <input  class="form-control col-md-7 col-xs-12"  name="logo" id="logo"  type="file">
                                            </div>
                            ...
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Manage_School/TeacherUpdate/<?php echo $row->id;?>" name="edit" id="edit" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_url">School URL <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_url"  id="school_url" value="<?php echo $schoolData->school_url?>" placeholder="School URL" required="required" type="text" autocomplete="off">
                                            <div class="text-info">No Space, No Capital Letter, No Special Character. Ex: south-point OR liverpool</div>
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_code">School Code</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_code"  id="school_code" value="<?php echo $schoolData->school_code?>" placeholder="School Code "  type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_name">School Name <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_name"  id="school_name" value="<?php echo $schoolData->school_name?>" placeholder="School Name" required="required" type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="address">Address <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="address"  id="address" value="<?php echo $schoolData->address?>" placeholder="Address " required="required" type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="phone">Phone <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="phone" value="<?php echo $schoolData->phone?>" placeholder="Phone" required="required" type="number" minlength="6" maxlength="20" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                ...
                                <div class="row">   
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="registration_date">Registration Date</label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="registration_date"  id="edit_registration_date" value="<?php echo $schoolData->registration_date?>" placeholder="Registration Date " type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="email">Email <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="email"  id="email" value="<?php echo $schoolData->email?>" placeholder="Email " required="required" type="email" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="school_fax">Fax </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="school_fax"  id="school_fax" value="<?php echo $schoolData->school_fax?>" placeholder="Fax " type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="footer">Footer </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="footer"  id="footer" value="<?php echo $schoolData->footer?> " placeholder="Footer " type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>                                                                    
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="currency">Currency </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="currency"  id="currency" value="<?php echo $schoolData->currency?>" placeholder="Currency " type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="currency_symbol">Currency Symbol <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="currency_symbol"  id="currency_symbol" value="<?php echo $schoolData->currency_symbol?>" placeholder="Currency Symbol " required="required" type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="final_result_type">Exam final result <span class="required">*</span></label>
                                            <select  class="form-control col-md-7 col-xs-12"  name="final_result_type" required="required">
                                                <option value="0" <?php echo $schoolData->final_result_type == "0"?"selected":""?>>Average of All Exam </option>
                                                <option value="1" <?php echo $schoolData->final_result_type == "1"?"selected":""?>>Only Based on Final Exam </option>
                                            </select>
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12"  name="language" required="required">
                                                <option value="">--Select--</option>
                                                                                                                                                    ...
                                                                                                                                                    <option value="arabic" >Arabic</option>
                                                                                                                                                    <option value="hindi" >Hindi</option>
                                                                                                                                                    <option value="urdu" selected="selected">Urdu</option>
                                                                                                                                                    <option value="chinese" >Chinese</option>
                                                                                                                                                    <option value="japanese" >Japanese</option>
                                                                                                                                                    <option value="portuguese" >Portuguese</option>
                                                                                                                                                    <option value="russian" >Russian</option>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12"  name="theme_name">
                                                <option value="">--Select--</option>
                                                                                                    ...
                                                                                                    <option style="color: #FFF;background-color: #000000;" value="black" >Black  </option>
                                                                                                    <option style="color: #FFF;background-color: #745D0B;" value="umber" >Umber </option>
                                                                                                    <option style="color: #FFF;background-color: #9370DB;" value="medium-purple" selected="selected">MediumPurple  </option>
                                                                                                    <option style="color: #FFF;background-color: #32CD32;" value="lime-green" >LimeGreen </option>
                                                                                                    <option style="color: #FFF;background-color: #663399;" value="rebecca-purple" >RebeccaPurple  </option>
                                                                                                    <option style="color: #FFF;background-color: #FB2E50;" value="radical-red" >Radical Red </option>
                                                                                                    <option style="color: #FFF;background-color: #1E90FF;" value="dodger-blue" >DodgerBlue </option>
                                ...
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="zoom_api_key">Zoom Api Key </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="zoom_api_key"  id="zoom_api_key" value="<?php echo $schoolData->zoom_api_key?>" placeholder="Zoom Api Key "  type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>    
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="zoom_secret">Zoom Secret </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="zoom_secret"  id="zoom_secret" value="<?php echo $schoolData->zoom_secret?>" placeholder="Zoom Secret "  type="text" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <div class="item form-group">
                                            <label for="google_map"> </label>
                                            <textarea  class="form-control col-md-6 col-xs-12 textarea-4column"  name="google_map"  id="google_map" placeholder="Google Map"><?php echo $schoolData->google_map?></textarea>
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="facebook_url">Facebook URL </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="facebook_url"  id="facebook_url" value="<?php echo $schoolData->facebook_url?>" placeholder="Facebook URL " type="url" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="twitter_url">Twitter URL </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="twitter_url"  id="twitter_url" value="<?php echo $schoolData->twitter_url?>" placeholder="Twitter URL " type="url" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="linkedin_url">Linkedin URL </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="linkedin_url"  id="linkedin_url" value="<?php echo $schoolData->linkedin_url?>" placeholder="Linkedin URL " type="url" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="youtube_url">Youtube URL </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="youtube_url"  id="youtube_url" value="<?php echo $schoolData->youtube_url?>" placeholder="Youtube URL " type="url" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="instagram_url">Instagram URL </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="instagram_url"  id="instagram_url" value="<?php echo $schoolData->instagram_url?>" placeholder="Instagram URL " type="url" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="pinterest_url">Pinterest URL </label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="pinterest_url"  id="pinterest_url" value="<?php echo $schoolData->pinterest_url?>" placeholder="Pinterest URL " type="url" autocomplete="off">
                                            <div class="help-block"></div> 
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="text-info">Dimension:- Max-W: 150px, Max-H: 90px</div>
                                            <div class="help-block"></div> 
                                            <img style="height:75px;width:100px;"src="<?php echo WEB_IMG?>image/<?php echo $row->frontend_logo?>"><br/><br/>
                                                 <input name="frontend_logo_prev" value=""  type="hidden">
                                                                                    </div>                                       
                                    </div>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <div class="text-info">Dimension:- Max-W: 100px, Max-H: 110px</div>
                                            <div class="help-block"></div> 
                                            <img style="height:75px;width:100px;"src="<?php echo WEB_IMG?>image/<?php echo $row->logo?>"><br/><br/>
                                                 <input name="logo_prev" value=""  type="hidden">
                                                                                    </div>                                       
                                    </div>

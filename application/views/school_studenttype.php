...
<html lang="en">
    <head>
        ...
        <title>Manage Student Type | vds jain</title>
                ...
                <div class="" data-example-id="togglable-tabs">                    
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                       ...
                                       foreach($student_types as $row)
                                       {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo WEB_URL?>Student/UpdateStudentType/<?php echo $row->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Edit </a>
                                                                                                                                            </td> 
                                        </tr>
                        ...
                        <div  class="tab-pane fade in " id="tab_add_type">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Student/StudentType" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">

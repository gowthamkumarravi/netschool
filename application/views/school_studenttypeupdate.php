...
<script type="text/javascript">
   ...
   | <a href="<?php echo WEB_DIR?>student/activity/index"> Student Activity</a>                    
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                    
                    <ul  class="nav nav-tabs bordered">
                        <li class=""><a href="#tab_type_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> List</a> </li>
                                                                                     <li  class=""><a href="<?php echo WEB_DIR?>student/type/add"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> Add</a> </li>                          
                                                      
                                                    <li  class="active"><a href="#tab_edit_type"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> Edit</a> </li>                          
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in " id="tab_type_list" >
                            <div class="x_content">
    ...
    ?>
                                            ...
                                            <td>
                                        <a href="<?php echo WEB_URL?>Student/UpdateStudentType/<?php echo $row->id;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> Edit </a>
                                                                                                                                            </td>
                                        </tr>
                        ...
                        <div  class="tab-pane fade in " id="tab_add_type">
                            <div class="x_content"> 
                               <form action="<?php echo WEB_DIR?>student/type/add" name="add" id="add" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
            ...
            <input class="fn_school_id" type="hidden" name="school_id" id="add_school_id" value="1" />
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a  href="<?php echo WEB_DIR?>student/type/index" class="btn btn-primary">Cancel</a>
                            ...
                            <div class="x_content"> 
                               <form action="<?php echo WEB_URL?>Student/UpdateStudentType/<?php echo $row->id;?>" name="edit" id="edit" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input class="fn_school_id" type="hidden" name="school_id" id="edit_school_id" value="1" />
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type">Student Type <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">                                        
                                        <input  class="form-control col-md-7 col-xs-12"  name="type" value="<?php echo $StudentTypeData->type?>"  placeholder="Student Type" required="required" type="text" autocomplete="off">
                                        <div class="help-block"></div>
                                    </div>
                                </div>    
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="note">Note</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="note"  id="note" placeholder="Note"><?php echo $StudentTypeData->note?></textarea>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
